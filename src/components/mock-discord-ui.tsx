    ...
    <div className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl">
      ...
      <div className="hidden md:flex w-69 bg-[#2f3136] flex-col">
        ...
        <div className="flex-1 overflow-y-auto pt-4">
          ...
          <div className="px-2 mb-4">
            <h3 className="text-xs text-[#8e9297] font-semibold px-2 mb-2 uppercase">
              Direct Messages
            </h3>
          </div>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="h-16 bg-[#36393f] flex items-center px-4 shadow-sm border-b border-[#202225]">
          ...
          <div className="ml-auto flex items-center space-x-4 text-[#b9bbbe]">
            ...
            <PhoneCall className="size-5 hover:text-white cursor-not-allowed hidden sm:block" />
        ...
        <div className="flex-1 flex flex-col-reverse overflow-auto p-4 bg-discord-background">
          {children}
        </div>
